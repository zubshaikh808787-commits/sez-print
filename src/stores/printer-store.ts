...
export type PrinterTransport = 'bluetooth-spp' | 'bluetooth-ble' | 'wifi' | 'josh-lpapi' | 'tez-spp' | 'dev-spp';
...
type PrinterStoreState = {
  ...
  sdkId: 'td404' | 'josh' | 'generic' | 'tez' | 'dev' | null;
  ...
  setConnectedDevice: (
    ...
    meta?: {
      ...
      sdkId?: 'td404' | 'josh' | 'generic' | 'tez' | 'dev';
      backendPrinterId?: string | null;
    },
  ) => void;
