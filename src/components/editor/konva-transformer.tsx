    ...
    return pan
      ...
      .onUpdate((e) => {
        ...
        if (
          ...
          groupDeltaLeftMm.value = clamped.left - anchorStartLeftMmSv.value;
          groupDeltaTopMm.value = clamped.top - anchorStartTopMmSv.value;
        }

        runOnJS(logLiveBoxJS)(clamped.left, clamped.top, clamped.width, clamped.height);
      })
      .onEnd((e) => {
        'worklet';
        liftSv.value = 1;
